...
class TestGraphToExample:
    def test_single_del(self, tmp_path, cfg, hg002_sample):
        ...
        assert image._example_label(example) == 2  # 1/1 genotype
        ...
        png_path = result_path("test.png")  # str(tmp_path / "test.png")
...
class TestVCFToExamples:
    ...
    def test_single_del(self, tmp_path, cfg, hg002_sample):
        ...
        for features, label in dataset:
            ...
            ), "Bi-allelic variant with single background should have 3 diploid genotypes"
