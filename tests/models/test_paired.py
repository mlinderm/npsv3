...
TEST_IMAGES = os.path.join(
    EXPERIMENTS_DIR,
    "training/freeze4.sv.alt.passing.training.hg38.images/HG00731/generator=coverage,pileup=unphased,simulation.replicates=1/images-0000.tar",
)
...
class TestPackedVariant:
    ...
    def test_paired_loss_callback(self, cfg):
        predict(cfg, limit_predict_batches=10)
